    ...
    <section className="relative min-h-screen w-full bg-black flex items-center grain">
      ...
      <div className="relative max-w-5xl mx-auto px-6 py-24 md:py-32 lg:py-40">
        <div className="max-w-3xl">
          {/* Headline */}
          <h1
            className="text-responsive-hero font-bold uppercase tracking-tight leading-[0.95] mb-6 md:mb-8 animate-fade-in"
          >
          ...
          {/* Subtext */}
          <p
            className="text-lg md:text-xl text-[#888] max-w-xl mb-10 md:mb-12 animate-fade-in"
      ...
      >
        <div className="w-px h-12 bg-gradient-to-b from-transparent via-[#333] to-[#666]" />
      </div>
