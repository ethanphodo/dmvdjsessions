  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-video bg-[#1A1A1A] overflow-hidden thumbnail-hover">
        ...
        {/* Play Button Overlay */}
        <div className="play-overlay absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity">
