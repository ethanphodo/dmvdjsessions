...
export const getSeriesById = (id) => seriesData.find((series) => series.id === id)
export const getActiveSeries = () => seriesData.filter((series) => series.status === 'active')
export const getPlannedSeries = () => seriesData.filter((series) => series.status === 'planned')
